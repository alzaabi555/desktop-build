...
const About: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-full p-6 animate-in fade-in zoom-in duration-500 relative z-10 transition-colors ${isRamadan ? 'text-white' : 'text-slate-900'}`}>
      ...
      <p className={`glass-card px-6 py-2 rounded-full font-black text-xs mb-10 border-none shadow-sm transition-colors ${isRamadan ? 'text-indigo-200 bg-white/10' : 'text-slate-500 bg-white'}`}>V 3.8.8 • الإصدار الملكي</p>
