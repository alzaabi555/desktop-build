...
const RamadanTheme: React.FC = () => {
  ...
  // إذا لم يكن رمضان، لا ترسم أي شيء (يختفي المكون تماماً ولا يستهلك موارد)
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden select-none">
      ...
      {/* 2. وهج ذهبي في الزوايا العلوية والسفلية */}
      ...
      {/* 3. الهلال الذهبي المضيء */}
      <div className="absolute top-12 right-12 opacity-80 hidden md:block">
        <Moon size={160} className="text-amber-300 fill-amber-300 drop-shadow-[0_0_30px_rgba(252,211,77,0.6)]" />
      </div>
      
      {/* هلال صغير للشاشات الصغيرة (الجوال) */}
      ...
      {/* 4. نجوم تتلألأ في السماء (تأثير النبض) */}
      ...
      <div className="absolute bottom-1/3 left-12 animate-pulse" style={{ animationDelay: '0.5s' }}>
